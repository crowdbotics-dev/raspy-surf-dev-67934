"""
Django settings for raspy_surf_dev_67934 project.
...
ROOT_URLCONF = 'raspy_surf_dev_67934.urls'
...
WSGI_APPLICATION = 'raspy_surf_dev_67934.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_surf_dev_67934 API",
    "DESCRIPTION": "API documentation for raspy_surf_dev_67934 App",
    "VERSION": "v1",
}
